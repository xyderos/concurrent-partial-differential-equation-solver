...
class test_multigrid_concurrent : public CPPUNIT_NS::TestCase {

    private:
	CPPUNIT_TEST_SUITE(test_multigrid_concurrent);
...
CPPUNIT_TEST_SUITE_REGISTRATION(test_multigrid_concurrent);
